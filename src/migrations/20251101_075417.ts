...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_users_role" AS ENUM('admin', 'user', 'viewer');
  ...
  CREATE TABLE "tenants" (
  	...
  	"settings_allow_public_analytics" boolean DEFAULT false,
  	"settings_max_websites" numeric DEFAULT 5,
  	"settings_retention_days" numeric DEFAULT 90,
  ...
  CREATE TABLE "analytics" (
  	...
  	"settings_track_page_views" boolean DEFAULT true,
  	"settings_track_events" boolean DEFAULT true,
  	"settings_track_sessions" boolean DEFAULT true,
  	"settings_ignore_bots" boolean DEFAULT true,
  	"settings_respect_do_not_track" boolean DEFAULT true,
  ...
  CREATE INDEX "analytics_tenant_idx" ON "analytics" USING btree ("tenant_id");
